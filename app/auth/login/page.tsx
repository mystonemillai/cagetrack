  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-texture">
      <div className="max-w-md w-full animate-fade-in">
        ...
        <h1 className="font-display text-4xl sm:text-5xl text-center mb-2">Welcome Back</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full p-4 bg-navy-light border border-wheat/15 rounded-lg text-offwhite focus:border-wheat outline-none transition-colors text-base"
              placeholder="your@email.com"
            />
          </div>

          <div>
            <div className="flex justify-between items-center mb-2"><label className="block text-xs uppercase tracking-widest text-offwhite/40">Password</label><Link href="/auth/forgot-password" className="text-[10px] text-wheat hover:underline">Forgot?</Link></div>
            <input
              type="password"
              value={password}
        ...
        <p className="text-center text-offwhite/30 text-sm mt-8">
          ...
          <Link href="/auth/signup" className="text-wheat hover:underline">Sign up</Link>
        </p>

        <p className="text-center text-offwhite/30 text-sm mt-2">
          Have an invite code?{' '}
          <Link href="/auth/claim-profile" className="text-wheat hover:underline">Claim Your Profile</Link>
        </p>
      </div>
    </div>
  );
