    ...
    <div className="min-h-screen bg-[#111827]">
      ...
      <nav className="px-6 py-5 flex justify-between items-center max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          <Link href="/auth/login" className="text-sm text-[#EAEAEA]/50 hover:text-[#F97316] transition-colors">Log In</Link>
      ...
      <section className="px-6 pt-16 pb-20 max-w-6xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link href="/auth/signup" className="px-8 py-4 bg-[#EAEAEA]/5 border border-[#EAEAEA]/10 text-[#EAEAEA] font-display text-lg tracking-wider rounded-xl hover:border-[#F97316]/30 transition-all">I&apos;m a Coach — It&apos;s Free</Link>
        </div>
      ...
      <section className="px-6 py-24 max-w-4xl mx-auto text-center">
        <h2 className="font-display text-4xl sm:text-6xl text-[#EAEAEA] mb-6">TRACK DEVELOPMENT.<br /><span className="text-[#F97316]">NOT JUST STATS.</span></h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link href="/auth/signup" className="px-8 py-4 bg-[#EAEAEA]/5 border border-[#EAEAEA]/10 text-[#EAEAEA] font-display text-lg tracking-wider rounded-xl hover:border-[#F97316]/30 transition-all">Sign Up as a Coach — Free</Link>
        </div>
      </section>
...
function FAQItem({ q, a }: { q: string; a: string }) {
  return (
    <details className="rounded-xl bg-[#111827] border border-[#F97316]/8 group">
      <summary className="p-5 cursor-pointer flex items-center justify-between text-sm font-medium text-[#EAEAEA] hover:text-[#F97316] transition-colors list-none">
        {q}
